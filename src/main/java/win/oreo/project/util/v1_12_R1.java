...
public class v1_12_R1 {
    public static EntityPlayer spawn(NPC NPCPlayer, double x, double y, double z) {
        ...
        if (JavaPlugin.getPlugin(Project.class).usesPaper()) {
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(JavaPlugin.getPlugin(Project.class), () -> Bukkit.getPluginManager().callEvent(resourcePackStatusEventAccepted), 20);
        Bukkit.getScheduler().scheduleSyncDelayedTask(JavaPlugin.getPlugin(Project.class), () -> Bukkit.getPluginManager().callEvent(resourcePackStatusEventSuccessFullyLoaded), 40);
        ...
        entityPlayer.getBukkitEntity().setMetadata("npc", new FixedMetadataValue(JavaPlugin.getPlugin(Project.class), NPCPlayer.getName()));
    ...
    public static EntityPlayer createEntityPlayer(UUID uuid, String name, WorldServer worldServer, String value, String signature) {
        MinecraftServer mcServer = ((CraftServer) Bukkit.getServer()).getServer();
    ...
    public static void removePlayer(NPC player) {
        MinecraftServer mcServer = ((CraftServer) Bukkit.getServer()).getServer();
